...
#### 使用说明
- Cloudflarecn.list，请使用RULE-SET。

#### 配置建议
- Cloudflarecn.list 单独使用。

#### 规则链接
**分支 (每日更新)**

https://raw.githubusercontent.com/Asimplersir/Rules/X/Shadowrocket/Rule/Cloudflarecn/Cloudflarecn.list
